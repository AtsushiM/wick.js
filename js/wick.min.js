...
V.run=function(a){var b,c,d,e,f,h;f=[];d={};h="";b=function(a){f.unshift(a);W[a]||(W[a]=1,a.match(/^(\/\/|http)/)?(f.unshift(a),e()):O(a,function(a){h=a+h;e()}))};e=function(){var a,d;(a=h.match(ha))?(d=a[1]+".js",h=h.slice(a.index+a[0].length),f.unshift(d),b(d)):c()};c=function(){var a,b,e;if(e=f.shift())d[e]?c():(d[e]=1,b=J.createElement("script"),a=function(){b.removeEventListener("load",a);c()},b.addEventListener("load",a),b.src=X(e),J.head.appendChild(b))};b(a+".js")};
Storage=F({l:function(){return this.e?[]:{}},init:function(a){this.e=(a||y).array||k;this.reset()},set:function(a,b){var c;R(a)||(c={},c[a]=b,a=c);for(c in a)this.f[c]=a[c]},get:function(a){var b,c,d;d=this.l();b=this.f;if(a)return b[a];for(c in b)d[c]=b[c];return d},remove:function(a){P(this.f[a])&&(this.e?I(this.data,a):delete this.f[a])},reset:function(){return this.f=this.l()}});
